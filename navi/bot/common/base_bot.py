...
from .navi_api_client import NaviAPIClient
...
class BaseBot(ABC):
    ...
    def __init__(self, config: BaseBotConfig):
        ...
        self.navi_client = NaviAPIClient(config)
    ...
    async def handle_message(self, message_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            return await self.message_handler.process_message(
                message_data, self.navi_client, self.session_manager, self
            )
