...
_global_loader: Optional[NaviMarkdownLoader] = None


def get_navi_loader() -> NaviMarkdownLoader:
    """グローバルNaviMarkdownLoaderインスタンスを取得"""
    global _global_loader
    
    if _global_loader is None:
        _global_loader = NaviMarkdownLoader()
