#!/usr/bin/env python3
"""
Navi CLI - プラットフォーム非依存の人生相談AIサーバー CLI
...
# 既存のサービスをインポート
from navi.core.dependencies import DependencyContainer
from navi.core.markdown_loader import get_navi_loader

app = typer.Typer(
    name="navi",
    help="Navi - プラットフォーム非依存の人生相談AIサーバー管理CLI",
...
def server(
    ...
    """
    console.print(Panel(
        f"[bold blue]Navi API Server[/bold blue]\n"
    ...
    import uvicorn
    from navi.main import app as fastapi_app
...
def version():
    ...
    """
    console.print(Panel(
        f"[bold blue]Navi CLI[/bold blue] v1.0.0\n"
