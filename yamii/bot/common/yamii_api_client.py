...
class YamiiAPIClient:
    ...
    async def __aenter__(self):
        ...
        self.session = aiohttp.ClientSession(
            timeout=aiohttp.ClientTimeout(total=self.config.yamii_api_timeout)
        )
        return self
    ...
    async def send_counseling_request(self, request: YamiiRequest) -> Optional[YamiiResponse]:
        """人生相談リクエストを送信"""
        try:
